...
Scheme
{
	...
	Colors
	{			
		/////////////////// Cubek Colors ///////////////// 																																							(nodankmemzeherexd)
	    ...
	    // background colors
		"ControlBG"			"38 38 38 255"		// background color of controls
		"ControlDarkBG"		"28 28 28 255"		// darker background color; used for background of scrollbars
		...
		"ListBG"			"38 38 38 255"		// background of server browser, buddy list, etc.
	}
	BaseSettings
	{
		// scheme-specific colors
		Border.Bright					"CkBlackLighter"	// the lit side of a control
		...
		CheckButton.Border2  			"CkBlackLighter"		// the right checkbutton border
		...
		Frame.OutOfFocusBgColor			"CkBlackLighter"
		FrameGrip.Color1				"CkBlack"
		FrameGrip.Color2				"CkBlackLighter"
		FrameTitleButton.FgColor		"CkWhite"
		FrameTitleBar.Font			"DefaultLarge"		[$WIN32]
		FrameTitleBar.TextColor			"CkWhite"
		FrameTitleBar.DisabledTextColor	"CkWhite"
		...
		ListPanel.SelectedOutOfFocusBgColor	"CkBlackLighter"
		
		MainMenu.TextColor			"CkWhite"			[$WIN32]
		...
		Menu.DividerColor		"CkBlackLighter"
